 ...
 * двигаться только вверх, конкретизация UNKNOWN -> IMM как наиболее
 * консервативный вариант для STA, то есть большие требования к глубине стека ->
 * меньше возможность underflow
 *
